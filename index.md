...
Another of matching samples uses what is called propensity scores. We want that the two samples of the pair have the same probability to be treated $\pi_{l} = \mathbb{P}(Z_{l} = 1 \mid r_{Cl}, r_{Tl}, \bold{x_{l}}, u_{l})$, with $Z_l$ the treatment, $r_{Cl}$ ..., $r_{Tl}$ ... , $\bold{x_{l}}$ ..., $u_{l}$ ....
...
<center><iframe frameborder="no" border="0" marginwidth="0" marginheight="0" width="1200" height="350" allowfullscreen="true" src="assets/img/prop_dist_before.png"></iframe></center>

<iframe frameborder="no" border="0" marginwidth="0" marginheight="0" width="900" height="300" allowfullscreen="true" src="assets/img/prop_dist_after.png"></iframe>
